...
import { CameraIcon, LoaderIcon, MapPinHouseIcon, ShipWheelIcon, ShuffleIcon } from "lucide-react";
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            profile preview"
                  ...
                  <div className="flex items-center justify-center h-full">
                    <CameraIcon className="size-12 text-base-content opacity-80" />
                  </div>
                )}
              </div>
            ...
            <div className="form-control">
              ...
              <div className="relative">
                <MapPinHouseIcon className="absolute top-1/2 transform -translate-y-1/2 left-3 size-5 text-base-content opacity-70 z-10" />
