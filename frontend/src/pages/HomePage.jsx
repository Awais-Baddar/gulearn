...
import FriendCard, { getLanguageFlag } from "../Componenets/FriendCard";
import NoFriends from "../Componenets/NoFriends";
...
const HomePage = () => {
  ...
  const { mutate: sendReqs, isPending } = useMutation({
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
              <div>
                ...
                <p className="opacity-70">
                  Discover perfect Learning partners and Instructors based on
                  your Interests
                </p>
              </div>
            </div>
